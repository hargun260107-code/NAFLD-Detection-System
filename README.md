...
ML-powered clinical decision support tool for Non-Alcoholic Fatty Liver Disease risk prediction.
...
The constant `TRAINING_FEATURES` (top of `app.py`) must match the **exact column
...
If your training dataset used different column names or a different order,
update this list and the `FEATURE_DEFAULTS` dictionary accordingly.
